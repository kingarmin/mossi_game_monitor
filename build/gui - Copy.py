...
def update_image(IM):
    ...
    image_lable.config(image=image_add)
...
زمان بازی: 10 دقیقه''', bg="#BEE6ce", fg="#000000", font=("Arial", 24),justify='right')
...
قیمت بلیط بای هر نفر: 150 هزار تومان
زمان بازی: 10 دقیقه''', bg="#FE5F55", fg="#000000", font=("Arial", 24),justify='right')
        label.place(x=screen_size['h']+resizer(230,'h'), y=resizer(62.0,'h')+resizer(100,'h'))
   else:
